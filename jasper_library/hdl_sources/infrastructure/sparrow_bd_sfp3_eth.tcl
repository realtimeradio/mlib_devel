...
################################################################
# This is a generated script based on design: sparrow_bd
#
...
proc create_root_design { parentCell } {
  ...
  set gt0_qplloutclk_in_0 [ create_bd_port -dir I gt0_qplloutclk_in_0 ]
  set gt0_qplloutrefclk_in_0 [ create_bd_port -dir I gt0_qplloutrefclk_in_0 ]
  set gtrefclk_0 [ create_bd_port -dir I -type clk -freq_hz 125000000 gtrefclk_0 ]
  set_property -dict [ list \
   CONFIG.PHASE {0} \
 ] $gtrefclk_0
  set gtrefclk_bufg_0 [ create_bd_port -dir I -type clk -freq_hz 125000000 gtrefclk_bufg_0 ]
  set_property -dict [ list \
   CONFIG.PHASE {0} \
 ] $gtrefclk_bufg_0
  set mmcm_locked_0 [ create_bd_port -dir I mmcm_locked_0 ]
  set pll_locked [ create_bd_port -dir O pll_locked ]
  set pma_reset_0 [ create_bd_port -dir I -type rst pma_reset_0 ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] $pma_reset_0
  set rxuserclk2_0 [ create_bd_port -dir I -type clk -freq_hz 62500000 rxuserclk2_0 ]
  set_property -dict [ list \
   CONFIG.PHASE {0} \
 ] $rxuserclk2_0
  set rxuserclk_0 [ create_bd_port -dir I -type clk -freq_hz 62500000 rxuserclk_0 ]
  set_property -dict [ list \
   CONFIG.PHASE {0} \
 ] $rxuserclk_0
  set userclk2_0 [ create_bd_port -dir I -type clk -freq_hz 125000000 userclk2_0 ]
  set_property -dict [ list \
   CONFIG.PHASE {0} \
 ] $userclk2_0
  set userclk_0 [ create_bd_port -dir I -type clk -freq_hz 62500000 userclk_0 ]
  set_property -dict [ list \
   CONFIG.PHASE {0} \
 ] $userclk_0
...
Flash#Quad SPI Flash#GPIO#GPIO#GPIO#I2C 0#I2C 0#GPIO#GPIO#UART 0#UART\
...
0#SD 0#PJTAG#PJTAG#PJTAG#PJTAG#GPIO#USB Reset#GPIO#GPIO} \
   CONFIG.PCW_MIO_TREE_SIGNALS {\
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#scl#sda#gpio[12]#gpio[13]#rx#tx#gpio[16]#gpio[17]#gpio[18]#gpio[19]#gpio[20]#gpio[21]#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#tdi#tdo#tck#tms#gpio[50]#reset#gpio[52]#gpio[53]} \
   ...
   CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 {0.01} \
   CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 {0.01} \
   CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY2 {0.01} \
   CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY3 {0.01} \
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins axi_slave_wishbone_c_0/S_AXI] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk200 [get_bd_ports clk_200] [get_bd_pins clk_wiz_0/clk200] [get_bd_pins gig_ethernet_pcs_pma_0/independent_clock_bufg] [get_bd_pins util_idelay_ctrl_0/ref_clk]
  ...
  connect_bd_net -net gt0_qplloutclk_in_0_1 [get_bd_ports gt0_qplloutclk_in_0] [get_bd_pins gig_ethernet_pcs_pma_0/gt0_qplloutclk_in]
  connect_bd_net -net gt0_qplloutrefclk_in_0_1 [get_bd_ports gt0_qplloutrefclk_in_0] [get_bd_pins gig_ethernet_pcs_pma_0/gt0_qplloutrefclk_in]
  connect_bd_net -net gtrefclk_0_1 [get_bd_ports gtrefclk_0] [get_bd_pins gig_ethernet_pcs_pma_0/gtrefclk]
  connect_bd_net -net gtrefclk_bufg_0_1 [get_bd_ports gtrefclk_bufg_0] [get_bd_pins gig_ethernet_pcs_pma_0/gtrefclk_bufg]
  connect_bd_net -net mmcm_locked_0_1 [get_bd_ports mmcm_locked_0] [get_bd_pins gig_ethernet_pcs_pma_0/mmcm_locked]
  connect_bd_net -net pma_reset_0_1 [get_bd_ports pma_reset_0] [get_bd_pins gig_ethernet_pcs_pma_0/pma_reset]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_reset [get_bd_pins gig_ethernet_pcs_pma_0/reset] [get_bd_pins rst_ps7_0_100M/peripheral_reset]
  connect_bd_net -net rxuserclk2_0_1 [get_bd_ports rxuserclk2_0] [get_bd_pins gig_ethernet_pcs_pma_0/rxuserclk2]
  connect_bd_net -net rxuserclk_0_1 [get_bd_ports rxuserclk_0] [get_bd_pins gig_ethernet_pcs_pma_0/rxuserclk]
  connect_bd_net -net userclk2_0_1 [get_bd_ports userclk2_0] [get_bd_pins gig_ethernet_pcs_pma_0/userclk2] [get_bd_pins processing_system7_0/ENET1_GMII_RX_CLK] [get_bd_pins processing_system7_0/ENET1_GMII_TX_CLK]
  connect_bd_net -net userclk_0_1 [get_bd_ports userclk_0] [get_bd_pins gig_ethernet_pcs_pma_0/userclk]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_idelay_ctrl_0/rst] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins gig_ethernet_pcs_pma_0/configuration_vector] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins processing_system7_0/ENET1_GMII_COL] [get_bd_pins processing_system7_0/ENET1_GMII_CRS] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins gig_ethernet_pcs_pma_0/signal_detect] [get_bd_pins xlconstant_2/dout]

  # Create address segments
  assign_bd_address -offset 0x51000000 -range 0x00400000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_slave_wishbone_c_0/S_AXI/reg0] -force
  assign_bd_address -offset 0x50000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs m_axil/Reg] -force
