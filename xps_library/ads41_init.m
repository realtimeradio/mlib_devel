...
function ads41_init(blk, varargin)

try
  clog('ads41_init: pre same_state','trace');
  defaults = { ...
    'block_name', blk, ...
  };
  if same_state(blk, 'defaults', defaults, varargin{:}), return, end
  clog('ads41_init: post same_state','trace');

  check_mask_type(blk, 'ads41');
