...
function last_tap_oversample4x_init(blk, varargin)
% Initialize and configure the last tap of the Polyphase Filter Bank.
%
% last_tap_oversample4x_init(blk, varargin)
%
...
check_mask_type(blk, 'last_tap_oversample4x');
munge_block(blk, varargin{:});


quantization = get_var('quantization','defaults', defaults, varargin{:});
set_param([blk,'/pfb_add_tree0'],'quantization',quantization);
set_param([blk,'/pfb_add_tree1'],'quantization',quantization);
set_param([blk,'/pfb_add_tree2'],'quantization',quantization);
set_param([blk,'/pfb_add_tree3'],'quantization',quantization);
